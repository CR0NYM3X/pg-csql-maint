...
1. **Lectura de Parámetros:** El orquestador recibe la orden: *"Busca tablas que cumplan la regla de bloat de manera sostenida por $p\_sustained\_days = 5$ días"*.
...
* Si hubo al menos un día donde la tabla se "desinfló" sola (ej. el Autovacuum reclamó espacio), significa que la tabla es volátil y respira. **Se cancela el bloqueo**.
...
### 🛡️ EL DEBATE CRÍTICO (La Intervención de Rodrigo - Gatekeeper)

*"Comandante, la lógica es hermosa en papel, pero como auditor técnico veo un riesgo grave de falsos negativos si no somos estrictos con el SQL."*
