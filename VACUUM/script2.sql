/* =========================================================================================
   ...
   VERSIÓN: V3.6.0 (Grado Diamante - Smart Triage, Dynamic User Context & Instance Control)
...
BEGIN 
    IF NOT EXISTS (
        ...
        WHERE table_schema = 'maint' AND table_name = 'vacuum_tasks' AND column_name = 'child_cookie'
    ) THEN 
        ALTER TABLE maint.vacuum_tasks ADD COLUMN child_cookie BIGINT; 
    END IF; 
END $$;
...
/* =========================================================================================
   PROCEDIMIENTO: maint.sp_orchestrate_vacuum (V3.6.0 - Dynamic Instance Control & User Context)
========================================================================================= */
...
BEGIN
    ...
    IF p_verbose THEN
        RAISE INFO '=========================================================';
        RAISE INFO '[DBA SQUAD] INICIANDO ORQUESTADOR VACUUM VANGUARD (V3.6.0 - EXT: %)', COALESCE(v_ext_version, 'v1.x');
