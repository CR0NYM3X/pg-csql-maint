/* =========================================================================================
   ...
   VERSIÓN: V4.0.0 (Grado Diamante - Smart Triage, Dynamic User Context & Instance Control)
...
BEGIN
    ...
    IF p_verbose THEN
        RAISE INFO '=========================================================';
        RAISE INFO '[DBA SQUAD] INICIANDO ORQUESTADOR VACUUM VANGUARD (V4.0.0 HOMOLOGADO - EXT: %)', COALESCE(v_ext_version, 'v1.x');
    ...
    -- 3. POBLAR COLA DE TAREAS V4.0.0 (TRIAGE CON REGLAS POLIMÓRFICAS JSONB Y SANITIZACIÓN)
