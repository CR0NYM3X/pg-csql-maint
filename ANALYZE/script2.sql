/* =========================================================================================
   ...
   VERSIÓN: V4.0.0 (Grado Diamante - Jerarquía Polimórfica JSONB Homologada, Instance Control & Dynamic Limits)
...
BEGIN
    ...
    IF p_verbose THEN
        RAISE INFO '=========================================================';
        RAISE INFO '[DBA SQUAD] INICIANDO ORQUESTADOR ANALYZE VANGUARD (V4.0.0 HOMOLOGADO - EXT: %)', COALESCE(v_ext_version, 'v1.x');
    ...
    WHILE v_current_stage <= v_max_stages LOOP
        ...
        -- POBLAR COLA PARA LA FASE ACTUAL CON V4.0.0 POLIMÓRFICO Y SANITIZACIÓN
