/* =========================================================================================
   ...
   VERSIÓN: V3.6.0 (Grado Diamante - Instance Control, Direct INTO Extraction & Polymorphic Immunity)
...
VALUES 
  ...
  ('max_parallel_vacuum_full_workers', '2', 'workers', 'Límite máximo dinámico de workers concurrentes para VACUUM FULL'),
...
/* =========================================================================================
   PROCEDIMIENTO: maint.sp_orchestrate_analyze (V3.6.0 - Instance Control & Dynamic Limits)
========================================================================================= */
...
BEGIN
    ...
    IF p_verbose THEN
        RAISE INFO '=========================================================';
        RAISE INFO '[DBA SQUAD] INICIANDO ORQUESTADOR ANALYZE VANGUARD (V3.6.0 - EXT: %)', COALESCE(v_ext_version, 'v1.x');
